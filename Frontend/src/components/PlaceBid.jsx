  ...
  useEffect(() => {
    const fetchAuctionDetails = async () => {
      try {
        ...
        const response = await axios.get(`https://online-auction-platform-1.onrender.com/api/auctions/${auctionId}`);
  ...
  const handleBidSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://online-auction-platform-1.onrender.com/api/auctions/${auctionId}/bid`,
        {
